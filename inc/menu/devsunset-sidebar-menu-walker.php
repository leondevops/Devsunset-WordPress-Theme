...
class Devsunset_Sidebar_Menu_Walker extends Walker_Nav_Menu {
  ...
  public function __construct()
  {
    ...
    //$this->debugger = new Custom_Theme_Debugger();
  }

  public static function createNavMenuWalkerObj(int $depth)
  {
    ...
    $walkerObj->currentIndexedItem = array();
    $level = 0;
    while ($level <= $depth) {
      $walkerObj->currentIndexedItem['level-' . $level] = 0;
      $level++;
    }
  ...
  public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
  {
    ...
    $currentMenuItemLi = array(
      ...
      'depth' => $depth,
      'registered-classnames' => (function ($arg) {
        return $arg->classes;
      })($item),
    ...
    if ($this->has_children && 0 === $depth) {
      ...
      // 2021-Nov-6 Move dropdown-toggle class to span button
    ...
    /* 2021-Nov-06 Update data-bs-toggle here */
    if( $this->has_children ){
      // Dropdown button - devsunset-dropdown-simple
      $item_output .= <<<HDSTR
      <span class="dropdown-toggle" data-bs-toggle="dropdown" submenu-open-status="0"
  ...
  private function get_custom_nav_menu_walker_classname(array $createdMenuItemLi): string
  {
    ...
    $strArray = array_map(function ($num) {
      return strval($num);
    }, $tmpIndexArray);
    ...
    // $this->debugger->write_variable_to_general_log($createdMenuItemLi);
...
//echo dirname(__DIR__).'/troubleshoot/custom-theme-debugger.php';
